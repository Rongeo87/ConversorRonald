...
public class function {
	...
	ConvertirMonedasAQuetales quetzales = new ConvertirMonedasAQuetales();
    ...
    public void ConvertirMonedas(double Minput) {
        ...
        case "De Euro a Quetzales":
        	quetzales.ConvertirEurosAQuetales(Minput);
        	break;
        case "De Libras a Quetzales":
        	quetzales.ConvertirLibrasAQuetales(Minput);
        	break;
        case "De Yen a Quetzales ":
        	quetzales.ConvertirYenAQuetales(Minput);
        	break;
        case "De Won Coreano a Pesos":
            quetzales.ConvertirWonAQuetales(Minput);
            break;
        }      
    }
